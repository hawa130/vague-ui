...
export const inputVariants = cva(
  'flex h-9 w-full rounded-md border border-input bg-button px-3 py-1 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-fg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring-focus focus-visible:ring-offset-0 focus-visible:border-ring-focus disabled:cursor-not-allowed disabled:opacity-50 transition-colors hover:border-ring-accent [&:not(:focus)]:hover:bg-accent-light',
)
